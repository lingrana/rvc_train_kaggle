...
from ultimate_rvc.security import safe_child, validate_remote_url
...
def validate_model(
    ...
    try:
        model_path = safe_child(Path(directory), name)
    except ValueError:
        raise ModelNotFoundError(entity, name=name) from None
