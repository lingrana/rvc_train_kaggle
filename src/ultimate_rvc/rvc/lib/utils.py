...
def load_embedding(embedder_model, custom_embedder=None):
    ...
    embedding_list = {
        ...
        "local-hubert-base": os.path.join(embedder_root, "hubert_base"),
    ...
    online_embedders = {
        ...
        "local-hubert-base": (
            "https://huggingface.co/lj1995/VoiceConversionWebUI/resolve/main/hubert_base/pytorch_model.bin"
        ),
        "spin": (
    ...
    config_files = {
        ...
        "local-hubert-base": (
            "https://huggingface.co/lj1995/VoiceConversionWebUI/resolve/main/hubert_base/config.json"
        ),
        "spin": (
